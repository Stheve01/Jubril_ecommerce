...
const Footer = () => {
  return (
    <div className='bg-black text-[#949494] py-20 font-monospace'>
        <div className='max-w-screen-xl mx-auto grid grid-cols-4'>
            <div className='flex flex-col gap-7'>
                <p className='text-white text-sm tracking-wide'>All rights reserved. <br/>© Jubril Furniture. Privacy Policy</p>
            ...
            <div>
                ...
                <div className='text-base flex flex-col gap-2'>
                    <p>3b Akinseye Close, Ogba</p>
                    <p>Mobile: 07019735950</p>
                    <p>Phone: 07019735950</p>
                    <p>E-mail: jubril@gmail.com</p>
                </div>
            </div>
